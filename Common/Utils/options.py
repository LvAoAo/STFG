...
def args_parser():
    ...
    # Lockdown arguments
    parser.add_argument('--anneal_factor', type=float, default=0.0001, help="anneal factor")
    parser.add_argument('--aggr', type=str, default='avg', help="aggregation method")
    parser.add_argument('--mask_init', type=str, default='ERK', help="mask initialization method")
    parser.add_argument('--dense_ratio', type=float, default=0.25, help="dense ratio")
    parser.add_argument('--same_mask', type=int, default=0, help="whether use the same mask for all clients")
    parser.add_argument('--theta', type=float, default=4, help="threshold")
